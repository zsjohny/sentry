...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MockData._timestamp'
        db.alter_column('sentry_mock_data', '_timestamp', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
        ...
        # Changing field 'MockData.remote_addr'
        db.alter_column('sentry_mock_data', 'remote_addr', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
        ...
        # Changing field 'MockData.remote_user'
        db.alter_column('sentry_mock_data', 'remote_user', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'MockData.method'
        db.alter_column('sentry_mock_data', 'method', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MockData.status'
        db.alter_column('sentry_mock_data', 'status', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.body_bytes_sent'
        db.alter_column('sentry_mock_data', 'body_bytes_sent', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData._timestamp'
        db.alter_column('sentry_mock_data', '_timestamp', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.protocol'
        db.alter_column('sentry_mock_data', 'protocol', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.http_referer'
        db.alter_column('sentry_mock_data', 'http_referer', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.remote_addr'
        db.alter_column('sentry_mock_data', 'remote_addr', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.url'
        db.alter_column('sentry_mock_data', 'url', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.remote_user'
        db.alter_column('sentry_mock_data', 'remote_user', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.method'
        db.alter_column('sentry_mock_data', 'method', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.http_x_forwarded_for'
        db.alter_column('sentry_mock_data', 'http_x_forwarded_for', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))

        # Changing field 'MockData.http_user_agent'
        db.alter_column('sentry_mock_data', 'http_user_agent', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))
    ...
    models = {
        ...
        'sentry.mockdata': {
            ...
            'body_bytes_sent': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'http_referer': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'http_user_agent': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'http_x_forwarded_for': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'protocol': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
