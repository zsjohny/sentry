...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('sentry', ['UserDetail'])

        # Adding model 'MockData'
        db.create_table('sentry_mock_data', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('remote_addr', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('remote_user', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('_timestamp', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('method', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('protocol', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('body_bytes_sent', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('http_referer', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('http_user_agent', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('http_x_forwarded_for', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
            ('_raw', self.gf('django.db.models.fields.CharField')(max_length=56, null=True)),
        ))
        db.send_create_signal('sentry', ['MockData'])


    def backwards(self, orm):
        # Deleting model 'UserDetail'
        db.delete_table('user_details')

        # Deleting model 'MockData'
        db.delete_table('sentry_mock_data')
    ...
    models = {
        ...
        'sentry.mockdata': {
            ...
            '_raw': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            '_timestamp': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'body_bytes_sent': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'http_referer': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'http_user_agent': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'http_x_forwarded_for': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'protocol': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'remote_addr': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'remote_user': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '56', 'null': 'True'})
        },
        'sentry.option': {
