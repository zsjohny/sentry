...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MockData._raw'
        db.alter_column('sentry_mock_data', '_raw', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'MockData._raw'
        db.alter_column('sentry_mock_data', '_raw', self.gf('django.db.models.fields.CharField')(max_length=56, null=True))
